...
import { Mic2, ArrowLeft, Mail, Lock, User } from 'lucide-react';
...
export default function Page() {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        setIsLogin(true);
        // Clear password but keep email and name for convenience
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex flex-col items-center justify-center p-6 pt-24 relative overflow-hidden text-white">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500">Master your craft with the power of AI.</p>
        </div>

        <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 shadow-2xl">
          <div className="flex p-1 bg-black/40 rounded-xl mb-8 border border-zinc-800">
            <button 
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    required
                    className="w-full bg-black/40 border border-zinc-800 rounded-xl py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-indigo-500 focus:bg-black/60 transition-all text-white placeholder-zinc-600" 
                  />
                </div>
              </div>
            )}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-500 text-white py-3.5 rounded-xl font-bold mt-4 transition-all shadow-xl shadow-indigo-900/40 active:scale-[0.98] disabled:opacity-50"
            >
