...
const SidebarItem: React.FC<SidebarItemProps> = ({ icon, label, active, onClick, danger }) => (
  <div
    onClick={onClick}
    className={`flex items-center space-x-3 px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 ${active
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to delete your account permanently? This action cannot be undone."
